...
def loop_cross_entropy_loss(trajs: list[Trajectory], model: AgentModel, n_subgoals: int = 0):
    """
...
def merge_cross_entropy_loss(trajs: list[Trajectory], model: AgentModel, n_subgoals: int = 0):
    forward = trajs[0].forward
