...
#SBATCH --exclusive
#SBATCH --output=/scratch/tjhia/bilevin/slurm_outputs/sok_t/%j.txt
...
argfile=/scratch/tjhia/bilevin/scripts/cedar/args.txt
...
python src/main.py \
    ...
    --mode "test" \
    --agent $agent \
    --problemset-path problems/docker_problems/sokoban_problems.json \
