...
#SBATCH --array=1-6
#SBATCH --exclusive
#SBATCH --output=/scratch/tjhia/bilevin/slurm_outputs/tri6_astar/%j.out
...
argfile=/scratch/tjhia/bilevin/scripts/beluga/tri_astar_args.txt
