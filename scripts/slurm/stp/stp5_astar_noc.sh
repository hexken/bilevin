...
#SBATCH --array=1-10
#SBATCH --output=/scratch/tjhia/bilevin/slurm_outputs/thes/stp5nc/astar/%j.out
...
python src/bilevin/main.py \
    ...
    --weight-astar 2.5 \
    --weight-mse-loss 1 \
    --runsdir-path runs/thes/stp5nc/astar \
    --exp-name "" \
    --problems-path problems/stp5nc/50000-train.pkl \
    --valid-path problems/stp5nc/1000-valid.pkl \
    --world-size 4 \
    --mode train \
    --max-grad-norm 1.0 \
    --loss-fn default \
