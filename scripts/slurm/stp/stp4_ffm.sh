...
#SBATCH --array=1-2
#SBATCH --output=/scratch/tjhia/bilevin/slurm_outputs/thes/stp4/ffm/%j.out
...
argfile=/scratch/tjhia/bilevin/scripts/slurm/stp/ff_args.txt
...
python src/bilevin/main.py \
    ...
    --agent $agent \
    --seed $seed \
    --runsdir-path runs/thes/stp4/ffm \
